...
class TestBooksCollector:
    ...
    def test_set_book_genre_set_genre(self):
        ...
        assert collector.get_books_genre()['Зловещие мертвецы 2'] == 'Ужасы'
    ...
    def test_get_books_genre_curent_status(self, list_book):
        for i in list_book.books_genre.keys():
            assert i in list_book.get_books_genre()
    ...
    def test_add_book_in_favorites_add_one(self):
        ...
        assert 'Джей и молчаливый Боб' in collector.get_books_genre() and collector.get_list_of_favorites_books()
    ...
    def test_delete_book_from_favorites_delete_one_book(self):
        ...
        collector.delete_book_from_favorites('Очень страшное кино')
